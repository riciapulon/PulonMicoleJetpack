package com.example.pulonmicolejetpack
...
fun Activity1()
{
    Column {
        Image(
            painter = painterResource(id = R.drawable.hatdog),
...
fun Activity2()
{
    Column (
        ...
        Image(
            painter = painterResource(id = R.drawable.hays),
            contentDescription = null,
            modifier = Modifier
                .width(280.dp)
                .height(280.dp)
    ...
    Box (
        ...
        Card( //q1
            colors = CardDefaults.cardColors(
                containerColor = Color(210, 233, 233),
            ...
            Column (
                ...
                Text(
                    text = "Display text and follows the" +
        ...
        Card( //q2
            colors = CardDefaults.cardColors(
                containerColor = Color(227, 244, 244),
        ...
        Card( //q3
            colors = CardDefaults.cardColors(
                containerColor = Color(248, 246, 244),
        ...
        Card( //q4
            colors = CardDefaults.cardColors(
                containerColor = Color(196, 223, 223),
            ),
            shape = RectangleShape,
            modifier = Modifier
                .fillMaxWidth(0.5f)
